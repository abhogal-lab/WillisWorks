...
**Version 21j · July 2026**  
Interactive cerebral hemodynamics teaching simulator  
Software created by **Alex A. Bhogal** and **Markus Fahlström**
...
the equations and constants implemented in WillisWorks v21j, including
later changes that are not present in the earlier v20g manual. The goal
...
> **Code-fidelity note:** This manual follows the uploaded WillisWorks v21j baseline. Where older documentation and the implementation differ, the implementation is treated as authoritative. Numerical constants identified as calibrations or heuristics are listed in Appendix A rather than presented as universal physiological values.
